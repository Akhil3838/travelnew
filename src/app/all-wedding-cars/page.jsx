...
import FiltersSidebar from "../components/weddingCar/FilterSidebar";
import CarCard from "../components/weddingCar/CarCard";
import MobileFilters from "../components/weddingCar/MobileFilter";
import Pagination from "../components/weddingCar/Pagination";
import { allWeddingACarApi, getWeddingCarFiltersApi } from "../services/allApi";
...
export default function Page() {
  ...
  const fetchFilters = async () => {
    ...
    try {
      const result = await getWeddingCarFiltersApi();
  ...
  const fetchCars = async () => {
    ...
    try {
      const res = await allWeddingACarApi(selectedFilters);
      console.log(res);
      

      if (res?.status) {
        setCars(res.data.weddingcars || []);
