...
//                 {[
//                   "https://media.tacdn.com/media/attractions-splice-spp-674x446/07/8f/78/23.jpg",
//                   "https://media.tacdn.com/media/attractions-splice-spp-674x446/0b/39/8d/7e.jpg",
//                   "https://www.travelandleisure.com/thmb/RQ3JmT8V2y2fhwr7NY0cgUumcCE=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/phuket-thailand-karst-formation-phuket0327-92bd3ce9266148dba74cba5e36c711e2.jpg",
...
//               <p className="lead text-light">Experience the awe-inspiring beauty of the Grand Canyon on this 4-day adventure from Las Vegas. This comprehensive tour takes you to the most spectacular viewpoints along the South Rim, with opportunities to explore Antelope Canyon and marvel at the engineering wonder of Hoover Dam. Travel in comfort with a small group and enjoy personalized attention from your expert guide.</p>
...
//                   }
//                 ].map((item, index) => (
//                   <div className="accordion-item border-0 rounded mb-3 bg-gray-800" key={index}>
//                     <h3 className="accordion-header" id={`heading${item.day}`}>
//                       <button
//                         className="accordion-button collapsed bg-gray-800  py-3 px-4"
//                         type="button"
...
//                       >
//                         <span className="badge bg-warning text-dark me-3">Day-{item.day}</span>
...
//                     >
//                       <div className="accordion-body px-4 pt-0 pb-3 bg-gray-800 text-muted">
...
//                 <div className="card-body">
//                   <h4 className="fw-bold mb-3  text-dark">Book This Tour</h4>

//                   {/* Date Picker */}
//                   <div className="mb-3">
//                     <label className="form-label  text-dark">Date:</label>
//                     <input type="date" className="form-control bg-white  border-secondary" />
//                   </div>

//                   {/* Time Selection */}
//                   <div className="mb-3">
//                     <label className="form-label d-block text-dark">Time:</label>
//                     <div className="form-check form-check-inline">
//                       <input className="form-check-input" type="radio" name="time" id="time1" />
//                       <label className="form-check-label text-dark" htmlFor="time1">12:00</label>
//                     </div>
//                     <div className="form-check form-check-inline">
//                       <input className="form-check-input" type="radio" name="time" id="time2" />
//                       <label className="form-check-label text-dark" htmlFor="time2">12:00</label>
//                     </div>
//                   </div>

//                   {/* Tickets Section */}
//                   <div className="mb-3">
//                     <label className="form-label text-dark">Tickets:</label>
//                     <div className="d-flex justify-content-between align-items-center mb-2">
//                       <span className="text-dark">Person (18+ years) ₹10.00</span>
//                       <select className="form-select w-auto  border-secondary">
//                         <option>1</option>
//                         <option>2</option>
//                         <option>3</option>
//                       </select>
...
//                       <span className="text-dark">Children (13-17 years) ₹10.00</span>
//                       <select className="form-select w-auto bg-dark text-light border-secondary">
//                         <option>0</option>
//                         <option>1</option>
//                         <option>2</option>
//                       </select>
...
//                   {/* Total Cost */}
//                   <div className="mb-3">
//                     <h5 className="d-flex justify-content-between text-dark">
//                       <span>Total Cost:</span>
//                       <span className="text-warning fw-bold fs-5">₹210.00</span>
//                     </h5>
//                   </div>

//                   {/* Book Now Button */}
//                   <button className="btn btn-warning text-dark w-100 fw-bold py-3 rounded-pill">
//                     BOOK NOW
//                   </button>
//                 </div>
//               </div>
...
//         <div className="container">
//           <h2 className="fw-bold mb-5 text-center text-white">You May Also Like</h2>
//           <div className="row">
//             <div className="col-md-6 mb-4">
//               <div className="card h-100 border-secondary bg-gray-800">
...
//                       </div>
//                       <h5 className="card-title text-white">4-Day Grand Canyon Small Group Tour from Las Vegas: South Rim, Antelope Canyon</h5>
...
//                             </span>
//                           </div>
//                           <a href="#" className="btn btn-sm btn-outline-warning rounded-pill px-3">
//                             View Details
//                           </a>
//                         </div>
//                       </div>
